...
#pragma inline=never
#endif
extern Void MSP_EXP430FR5994_isrDMA(UArg);
#if defined(__ICC430__)
#pragma vector = 42 * 2
#else
#pragma vector = 42;
...
extern Void ti_sysbios_family_msp430_Hwi48_p2(Void);

#if defined(__ICC430__)
#pragma inline=never
#endif
extern Void UARTEUSCIA_hwiIntFxn(UArg);
#if defined(__ICC430__)
#pragma vector = 48 * 2
#else
#pragma vector = 48;
...
__interrupt Void ti_sysbios_family_msp430_Hwi48(Void)
{
    ...
    /* switch stacks and then run the phase 2 function */
    ti_sysbios_family_xxx_Hwi_switchAndRunFunc(&ti_sysbios_family_msp430_Hwi48_p2);
